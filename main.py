...
async def get_precios(skip: int = Query(0, description="Número de registros a saltar"), limit: int = Query(100, description="Número máximo de registros a devolver")):
    """Get paginated fuel prices from the dataset."""
    try:
        ...
        return {
            ...
            "registros_mostrados": len(paginated_data),
